// src/screens/admin/PackhouseManagementScreen.js
...
const PackhouseSchema = Yup.object().shape({
  name: Yup.string().required('Packhouse name is required'),
...
export default function PackhouseManagementScreen({ navigation }) {
  const dispatch = useDispatch();
  const { packhouses, loading, error, success } = useSelector((state) => state.admin);
  ...
  // Load packhouses from API
  const loadPackhouses = () => {
    ...
    <Card style={styles.card}>
      <Card.Content>
        ...
        <View style={styles.cardRow}>
          ...
          <Text style={styles.cardText}>Capacity: {item.capacity} crates</Text>
        </View>
      </Card.Content>
    </Card>
  );
  ...
  const renderEmpty = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyText}>No Packhouses Found</Text>
      <Text style={styles.emptySubtext}>
        Add a new packhouse to get started
      </Text>
    </View>
  );
    ...
    <View style={styles.container}>
      ...
      {loading && !refreshing ? (
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Loading packhouses...</Text>
        </View>
      ) : (
        <FlatList
          data={packhouses}
          renderItem={renderPackhouseItem}
